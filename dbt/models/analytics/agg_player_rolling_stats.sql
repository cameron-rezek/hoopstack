...
rolling as (
    select
        ...
        round(avg(effective_fg_pct) over w5, 3) as efg_pct_avg_5g,
        round(avg(usage_rate)   over w5, 1) as usage_avg_5g,
        round(avg(assist_pct)   over w5, 1) as assist_pct_avg_5g,
        round(avg(turnover_pct) over w5, 1) as turnover_pct_avg_5g,
        round(avg(offensive_rebound_pct) over w5, 1) as oreb_pct_avg_5g,
        round(avg(defensive_rebound_pct) over w5, 1) as dreb_pct_avg_5g,
        ...
        round(avg(effective_fg_pct) over w10, 3) as efg_pct_avg_10g,
        round(avg(usage_rate)   over w10, 1) as usage_avg_10g,
        round(avg(assist_pct)   over w10, 1) as assist_pct_avg_10g,
        round(avg(turnover_pct) over w10, 1) as turnover_pct_avg_10g,
        round(avg(offensive_rebound_pct) over w10, 1) as oreb_pct_avg_10g,
        round(avg(defensive_rebound_pct) over w10, 1) as dreb_pct_avg_10g,
        ...
        round(avg(effective_fg_pct) over w20, 3) as efg_pct_avg_20g,
        round(avg(usage_rate)   over w20, 1) as usage_avg_20g,
        round(avg(assist_pct)   over w20, 1) as assist_pct_avg_20g,
        round(avg(turnover_pct) over w20, 1) as turnover_pct_avg_20g,
        round(avg(offensive_rebound_pct) over w20, 1) as oreb_pct_avg_20g,
        round(avg(defensive_rebound_pct) over w20, 1) as dreb_pct_avg_20g,
        ...
        round(avg(effective_fg_pct) over wseason, 3) as efg_pct_avg_season,
        round(avg(usage_rate)   over wseason, 1) as usage_avg_season,
        round(avg(assist_pct)   over wseason, 1) as assist_pct_avg_season,
        round(avg(turnover_pct) over wseason, 1) as turnover_pct_avg_season,
        round(avg(offensive_rebound_pct) over wseason, 1) as oreb_pct_avg_season,
        round(avg(defensive_rebound_pct) over wseason, 1) as dreb_pct_avg_season,
